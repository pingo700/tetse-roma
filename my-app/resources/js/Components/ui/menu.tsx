  ...
  return (
    <ScrollArea className="[&>div>div[style]]:!block">
      <nav className="mt-8 h-full w-full">
        <ul className="flex flex-col min-h-[calc(75vh-48px-36px-16px-32px)] lg:min-h-[calc(70vh-32px-40px-32px)] items-start space-y-1 px-2">
              ...
              <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                  <Button
                    onClick={() => {}}
                    variant="outline"
                    className="w-full justify-center h-10 mt-5 bg-main hover:bg-main-light"
                  >
